...
excerpt: "Many NFL teams have historically struggled to draft and develop franchise quarterbacks. Can we use machine learning to project which recent draftees will succeed in the pros?"
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/fig1-qbclusters.png" alt="quarterback cluster scatterplot">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/fig2-group8qbs.png" alt="most successful quarterbacks">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/cm-training.png" alt="training confusion matrix">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/cm-test.png" alt="test confusion matrix 1">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/success-failure-tossup-1.png" alt="success likelihood chart 1">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/cm-test-2.png" alt="test confusion matrix 2">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/success-failure-tossup-2.png" alt="success likelihood chart 2">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/success-failure-tossup-10K.png" alt="success likelihood chart 10,000">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/dist_beathard_trubisky.png" alt="beathard trubisky success distributions">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/mean_projection_vs_variability.png" alt="qb projections against variability">{: .center-image }
...
<img src="{{ site.url }}{{ site.baseurl }}/images/nfl_qbs/5bins.png" alt="qb success bin results">{: .center-image }

<sub><center>To view full-size image, right-click and select "Open image in new tab."</center></sub>
...
All data and code are available on my GitHub: [https://github.com/saisenberg](https://github.com/saisenberg)
